...
exports.push = {
   ...
   'displays tree for initial commit hash': function displaysTreeForInitialCommitHash(test) {

      git.catFile(['-p', '366e4409'], function (err, result) {

         test.equals(null, err, 'not an error');
         test.same(['cat-file', '-p', '366e4409'], setup.theCommandRun());
         test.same(['100644 blob bb8fa279535700c922d3f1ffce064cb5d40f793d    .gitignore', '100644 blob 38e7c92830db7dc85d7911d53f7478d9311f4c81    .npmignore', '100644 blob a7eb4e85cdb50cc270ddf4511e72304c264b0baf    package.json', '100644 blob e9028d5b1f9bd80c7f1b6bacba47cb79b637164a    readme.md', '040000 tree b0a0e1d44895fa659bd62e7d94187adbdf5ba541    src'].join('\n'), result);

         test.done();
      });

      setup.closeWith(['100644 blob bb8fa279535700c922d3f1ffce064cb5d40f793d    .gitignore', '100644 blob 38e7c92830db7dc85d7911d53f7478d9311f4c81    .npmignore', '100644 blob a7eb4e85cdb50cc270ddf4511e72304c264b0baf    package.json', '100644 blob e9028d5b1f9bd80c7f1b6bacba47cb79b637164a    readme.md', '040000 tree b0a0e1d44895fa659bd62e7d94187adbdf5ba541    src'].join('\n'));
   },

   'displays valid usage when no arguments passed': function displaysValidUsageWhenNoArgumentsPassed(test) {
   ...
   'optionally returns a buffer of raw data': function optionallyReturnsABufferOfRawData(test) {
