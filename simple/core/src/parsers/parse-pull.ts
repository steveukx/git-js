import type { PullDetail, PullFailedResult, PullResult } from '../responses/PullSummary';
...
import type { RemoteMessages } from './parse-remote-messages';
...
export function parsePullErrorResult(
   stdOut: string,
   stdErr: string
): PullFailedSummary | undefined {
   const pullError = parseStringResponse(new PullFailedSummary(), errorParsers, [stdOut, stdErr]);

   return pullError.message ? pullError : undefined;
}
