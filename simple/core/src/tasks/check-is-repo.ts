...
import { ExitCodes, filterString, filterType } from '../utils';
...
export function checkIsRepo(checkType?: CheckRepoActions): StringTask<boolean> {
   return checkIsRepoTask(filterType(checkType, filterString) as Maybe<CheckRepoActions>);
}
