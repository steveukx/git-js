...
export function notEmpty<T>(input: Array<T | void | undefined>): T[] {
...
export function orVoid<T>(input: T | false): T | undefined {
   if (input === false) {
      return undefined;
   }
   return input;
...
export function once<This, Args extends unknown[], Result>(
   what: (this: This, ...args: Args) => Result
