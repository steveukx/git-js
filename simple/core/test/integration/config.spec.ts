import { GitConfigScope } from '../../index';
...
describe('config', () => {
   ...
   // config writes are deny-by-default in @simple-git/core (§2.7)
   beforeEach(() => (git = newSimpleGit(context.root, { allowConfigWrite: ['user.name'] })));
