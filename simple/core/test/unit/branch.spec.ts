import type { BranchSingleDeleteResult, BranchSummary, SimpleGitCore } from '../../index';
import { parseBranchSummary } from '../../src/parsers/parse-branch';
import { BranchSummaryResult } from '../../src/responses/BranchSummary';
import {
...
describe('branch', () => {
   ...
   describe('deleting branches', () => {
      ...
      it('delete local branch with -d option', async () => {
         ...
         const result = git.branch(options);
